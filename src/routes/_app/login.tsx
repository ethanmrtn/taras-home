  ...
  return (
    <div className="relative flex min-h-svh items-center justify-center p-6 overflow-hidden">
      ...
      <svg
        ...
        style={{ rotate: "15deg", filter: "drop-shadow(0 1px 2px rgba(61,53,41,0.1))" }}
      >
      ...
      <svg
        ...
        style={{ rotate: "-10deg", filter: "drop-shadow(0 1px 2px rgba(61,53,41,0.1))" }}
      >
      ...
      <svg
        ...
        style={{ rotate: "30deg", filter: "drop-shadow(0 1px 2px rgba(61,53,41,0.1))" }}
      >
        <path d="M10 0l2 8 8 2-8 2-2 8-2-8-8-2 8-2z" />
      </svg>

      <LoginForm className="relative z-10 w-full max-w-sm" redirectTo={redirect} />
    </div>
  );
}
